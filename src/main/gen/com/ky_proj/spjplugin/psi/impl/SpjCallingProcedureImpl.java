...
public class SpjCallingProcedureImpl extends SpjNamedElementImpl implements SpjCallingProcedure {

  public SpjCallingProcedureImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SpjVisitor visitor) {
    visitor.visitCallingProcedure(this);
  }
  ...
  @Override
  @NotNull
  public SpjProcCall getProcCall() {
    return findNotNullChildByClass(SpjProcCall.class);
  }
